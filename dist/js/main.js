...
const ssPablosHeads = new Roger.RegularSheet(pabloHeads.url, pabloHeads.sheetSize, pabloHeads.spriteSize);
const spEyesClosed = new Roger.Animation("closed", ssPablosHeads, [11]);

const animPablos_blink1 = new Roger.Animation("blink1", ssPablosHeads, [0, 1, 2, 1], {
	delay: 0
});
...
const rClock = new Roger.Clock(0.2);
